...
@interface HCGPaperVC ()<UIActionSheetDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIAlertViewDelegate,PhotoTweaksViewControllerDelegate,GetHCGResultDelegate,UITableViewDataSource,UITableViewDelegate>
{
...
- (void)photoTweaksController:(PhotoTweaksViewController *)controller didFinishWithCroppedImage:(UIImage *)croppedImage
{
    ...
    hcgResult.resultImage = croppedImage;
    hcgResult.delegate = self;
    [self.navigationController pushViewController:hcgResult animated:YES];
}

#pragma mark ========= HCGResultVCDelegate
...
- (void)HCGcameraEdit
{
    ...
    [notifyCenter addObserver:self selector:@selector(cameraResult:) name:@"HCGcamera" object:nil];
}
